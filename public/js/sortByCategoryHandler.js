// TRI PAR CATEGORIE
const formSubmit = document.querySelector('.sort-form');
...
if (formSubmit !== null) {
    formSubmit.addEventListener('submit', function (event) {
        ...
        fetch('/api/resultByCategory', {
            ...
            .catch(error => {
                console.error('Problème avec l\'opération fetch !')
            })
